...
FINE_Z2L_2_Z2R_2 = {
    # key = (b1_own, b1_bar, b2_own, b2_bar, bb1_own, bb1_bar, bb2_own, bb2_bar)
    ((), (), (), (), (), (), (), ()): "I-I",
    ((), (), (3, 5), (1,), (), (), (3, 5), (1,)): "II-II",
    ((), (), (3, 5), (5,), (1,), (1,), (3, 5, 6), (2,)): "II-IV",
    ((1,), (1,), (3, 5, 6), (2,), (), (), (3, 5), (5,)): "IV-II",
    ((), (), (3, 4, 5, 6), (1, 2), (), (), (3, 4, 5, 6), (1, 2)): "III-III",
    ((), (), (3, 4, 5, 6), (2, 4), (1,), (1,), (3, 5, 6), (2,)): "III-IV",
    ((1,), (1,), (3, 5, 6), (2,), (), (), (3, 4, 5, 6), (2, 4)): "IV-III",
    ((1,), (2,), (3, 5, 6), (4,), (1,), (2,), (3, 5, 6), (4,)): "IV-IV.1",
    ((1,), (2,), (3, 5, 6), (5,), (1,), (2,), (3, 5, 6), (5,)): "IV-IV.2",
    ((1,), (4,), (3, 5, 6), (5,), (1,), (5,), (3, 5, 6), (2,)): "IV-IV.3",
    ((1,), (5,), (3, 5, 6), (2,), (1,), (4,), (3, 5, 6), (5,)): "IV-IV.4",
    ((1,), (5,), (3, 5, 6), (4,), (1,), (5,), (3, 5, 6), (4,)): "IV-IV.5",
    ((1,), (5,), (3, 5, 6), (6,), (1,), (5,), (3, 5, 6), (6,)): "IV-IV.6",
    ((1,), (4,), (3, 5, 6), (2,), (1,), (4,), (3, 5, 6), (2,)): "IV-IV.7",
    ((1,), (1,), (3, 5, 6), (3,), (1, 2), (4, 5), (3, 4, 5, 6), (2, 5)): "IV-V.1",
    ((1, 2), (4, 5), (3, 4, 5, 6), (2, 5), (1,), (1,), (3, 5, 6), (3,)): "V-IV.1",
    ((1,), (1,), (3, 5, 6), (5,), (1, 2), (4, 5), (3, 4, 5, 6), (2, 4)): "IV-V.2",
    ((1, 2), (4, 5), (3, 4, 5, 6), (2, 4), (1,), (1,), (3, 5, 6), (5,)): "V-IV.2",
    ((1,), (3,), (3, 5, 6), (1,), (1, 2), (2, 5), (3, 4, 5, 6), (4, 5)): "IV-V.3",
    ((1, 2), (2, 5), (3, 4, 5, 6), (4, 5), (1,), (3,), (3, 5, 6), (1,)): "V-IV.3",
    ((1,), (3,), (3, 5, 6), (5,), (1, 2), (2, 4), (3, 4, 5, 6), (4, 5)): "IV-V.4",
    ((1, 2), (2, 4), (3, 4, 5, 6), (4, 5), (1,), (3,), (3, 5, 6), (5,)): "V-IV.4",
    ((1,), (5,), (3, 5, 6), (1,), (1, 2), (2, 5), (3, 4, 5, 6), (2, 4)): "IV-V.5",
    ((1, 2), (2, 5), (3, 4, 5, 6), (2, 4), (1,), (5,), (3, 5, 6), (1,)): "V-IV.5",
    ((1,), (5,), (3, 5, 6), (3,), (1, 2), (2, 4), (3, 4, 5, 6), (2, 5)): "IV-V.6",
    ((1, 2), (2, 4), (3, 4, 5, 6), (2, 5), (1,), (5,), (3, 5, 6), (3,)): "V-IV.6",
    ((1, 2), (1, 3), (3, 4, 5, 6), (1, 5), (1, 2), (1, 3), (3, 4, 5, 6), (1, 5)): "V-V.1",
    ((1, 2), (1, 3), (3, 4, 5, 6), (3, 5), (1, 2), (1, 5), (3, 4, 5, 6), (1, 3)): "V-V.2",
    ((1, 2), (1, 5), (3, 4, 5, 6), (1, 3), (1, 2), (1, 3), (3, 4, 5, 6), (3, 5)): "V-V.3",
    ((1, 2), (1, 5), (3, 4, 5, 6), (4, 5), (1, 2), (1, 5), (3, 4, 5, 6), (4, 5)): "V-V.4",
    ((1, 2), (3, 5), (3, 4, 5, 6), (1, 3), (1, 2), (3, 5), (3, 4, 5, 6), (1, 3)): "V-V.5",
    ((1, 2), (3, 5), (3, 4, 5, 6), (1, 5), (1, 2), (3, 5), (3, 4, 5, 6), (1, 5)): "V-V.6",
    ((1, 2), (1, 2), (3, 4), (3, 4), (1, 2), (1, 2), (3, 4), (3, 4)): "VI-VI.1",
    ((1, 2), (1, 2), (3, 4), (3, 5), (1, 2), (1, 2), (3, 4), (3, 5)): "VI-VI.2",
    ((1, 2), (1, 2), (3, 4), (5, 6), (1, 2), (1, 2), (3, 4), (5, 6)): "VI-VI.3",
    ((1, 2), (1, 3), (3, 4), (2, 4), (1, 2), (1, 3), (3, 4), (2, 4)): "VI-VI.4",
    ((1, 2), (1, 3), (3, 4), (4, 5), (1, 2), (1, 3), (3, 4), (2, 5)): "VI-VI.5",
    ((1, 2), (1, 3), (3, 4), (4, 5), (1, 2), (1, 5), (3, 4), (2, 3)): "VI-VI.6",
    ((1, 2), (1, 3), (3, 4), (5, 6), (1, 2), (1, 5), (3, 4), (2, 6)): "VI-VI.7",
    ((1, 2), (1, 5), (3, 4), (2, 3), (1, 2), (1, 3), (3, 4), (4, 5)): "VI-VI.8",
    ((1, 2), (1, 5), (3, 4), (2, 6), (1, 2), (1, 3), (3, 4), (5, 6)): "VI-VI.9",
    ((1, 2), (3, 4), (3, 4), (1, 2), (1, 2), (3, 4), (3, 4), (1, 2)): "VI-VI.10",
    ((1, 2), (3, 4), (3, 4), (1, 5), (1, 2), (3, 5), (3, 4), (1, 2)): "VI-VI.11",
    ((1, 2), (3, 4), (3, 4), (5, 6), (1, 2), (5, 6), (3, 4), (1, 2)): "VI-VI.12",
    ((1, 2), (3, 5), (3, 4), (1, 2), (1, 2), (3, 4), (3, 4), (1, 5)): "VI-VI.13",
    ((1, 2), (3, 5), (3, 4), (1, 4), (1, 2), (3, 5), (3, 4), (1, 4)): "VI-VI.14",
    ((1, 2), (3, 5), (3, 4), (1, 6), (1, 2), (3, 5), (3, 4), (1, 6)): "VI-VI.15",
    ((1, 2), (3, 5), (3, 4), (4, 6), (1, 2), (5, 6), (3, 4), (1, 3)): "VI-VI.16",
    ((1, 2), (5, 6), (3, 4), (1, 2), (1, 2), (3, 4), (3, 4), (5, 6)): "VI-VI.17",
    ((1, 2), (5, 6), (3, 4), (1, 3), (1, 2), (3, 5), (3, 4), (4, 6)): "VI-VI.18",
    ((1, 2), (5, 6), (3, 4), (3, 4), (1, 2), (5, 6), (3, 4), (3, 4)): "VI-VI.19",
    ((1, 2), (1, 5), (3, 4), (3, 4), (1, 2), (1, 5), (3, 4), (3, 4)): "VI-VI.20",
    ((1, 2), (1, 5), (3, 4), (3, 6), (1, 2), (1, 5), (3, 4), (3, 6)): "VI-VI.21",
}
...
def label_Z2L_2_Z2R_2(row) -> str:
    ...
    coarse = f"{ivi_1}-{ivi_2}"

    key = (
        _idx_set(n), _idx_set(N),
        tuple(i + 3 for i, v in enumerate(m) if int(v) == 1), _idx_set(M),
        _idx_set(k), _idx_set(K),
        tuple(i + 3 for i, v in enumerate(l) if int(v) == 1), _idx_set(L),
    )
    fine = FINE_Z2L_2_Z2R_2.get(key)
    if fine is None:
        print(f"  [Z2L_2_Z2R_2] no fine match for key={key}, falling back to coarse label {coarse!r}")
        return coarse
    if fine.split(".")[0] != coarse:
        raise ValueError(f"Fine/coarse mismatch: fine={fine!r} coarse={coarse!r} key={key}")
    return fine
